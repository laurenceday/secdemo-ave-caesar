...
/// @notice AggregatorV3-shaped NAV feed mock (NAVLink stand-in): settable
///         answer and updatedAt, 6 decimals like the USTB NAV feeds.
contract MockNavFeed {
...
/// @notice Superstate RedemptionIdle mock: settable capacity and pause flag.
contract MockRedemption {
    ...
    function maxUstbRedemptionAmount() external view returns (uint256, uint256) {
        return (capacity, 11_144_444);
    }
