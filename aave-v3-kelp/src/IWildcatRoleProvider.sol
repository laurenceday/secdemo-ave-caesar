...
// Mirrored verbatim from Wildcat v2 (deposit-hook branch), src/access/IRoleProvider.sol.
// In an integration repo, import Wildcat's original instead of this mirror.
